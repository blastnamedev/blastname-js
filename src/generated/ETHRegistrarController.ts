...
export interface ETHRegistrarControllerInterface extends Interface {
  functions: {
    ...
    "makeCommitment(string,address,uint256,bytes32,address,bytes[],bool,uint16,bytes32,address)": FunctionFragment;
    ...
    "register(string,address,uint256,bytes32,address,bytes[],bool,uint16,bytes32,address)": FunctionFragment;
    "renew(string,uint256)": FunctionFragment;
    "renounceOwnership()": FunctionFragment;
    "rentPrice(string,uint256,uint8)": FunctionFragment;
  ...
  events: {
    "NameRegistered(string,bytes32,address,uint256,uint256,uint256,uint256,bytes32)": EventFragment;
...
export interface ETHRegistrarController extends BaseContract {
  ...
  functions: {
    ...
    makeCommitment(
      ...
      refAddress: PromiseOrValue<string>,
      overrides?: CallOverrides
    ): Promise<[string]>;
    ...
    rentPrice(
      name: PromiseOrValue<string>,
      duration: PromiseOrValue<BigNumberish>,
      rentPriceType: PromiseOrValue<BigNumberish>,
      overrides?: CallOverrides
    ): Promise<
    ...
    voucher(overrides?: CallOverrides): Promise<[string]>;
  ...
  filters: {
    "NameRegistered(string,bytes32,address,uint256,uint256,uint256,uint256,bytes32)"(
      name?: null,
