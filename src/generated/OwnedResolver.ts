...
export interface OwnedResolverInterface extends Interface {
  functions: {
...
export interface OwnedResolver extends BaseContract {
  ...
  functions: {
    ...
    /**
     * setZonehash sets the hash for the zone. May only be called by the owner of that node in the ENS registry.
